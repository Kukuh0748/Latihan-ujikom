...
<header>
  ...
  <div class="p-5 text-center bg-light">
	...
	<!--table tambah data dosen-->
	<table class="table align-middle mb-0 bg-white">
		<div class="input-group mb-3">
  			<span class="input-group-text" id="basic-addon1">Kode Dosen</span>
  			<input type="text" name="kd_dosen" class="form-control" aria-label="Kode Dosen" aria-describedby="basic-addon1" required/>
		</div>
		<div class="input-group mb-3">
  			<span class="input-group-text" id="basic-addon1">Nama Dosen</span>
  			<input type="text" name="nm_dosen" class="form-control" aria-label="Nama Dosen" aria-describedby="basic-addon1" required/>
		</div>
		<div class="form-outline">
			<span class="input-group-text" id="basic-addon1">Alamat</span>
  			<textarea class="form-control" name="alamat" id="textAreaExample" rows="4"></textarea>
		</div>
	...
	<!--akhir table tambah data dosen-->
	</form>
<!--akhir form tambah data dosen-->
  </div>
