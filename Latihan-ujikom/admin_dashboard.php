...
<header>
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item active">
            <a class="nav-link" aria-current="page" href="admin_dashboard.php">Beranda</a>
          </li>
          <li class="nav-item">
  ...
  <div class="p-5 text-center bg-light">
    <h1 class="mb-3">Selamat Data di Aplikasi ...</h1>
    <h4 class="mb-3">Web ini dibuat untuk keperluan Uji Kompetensi Gelombang 27</h4>
    <br>
    <p class="mb-3">Nama : Raden Wirawan Kukuh Pambudi</p>
    <p class="mb-3">Nomor Peserta : 220401070815</p>
    <p class="mb-3">Prodi : Teknik Informatika</p>
    <h5 class="mb-3">Universitas Pamulang</h5>
  </div>
